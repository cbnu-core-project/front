...
function ManagerSignUp(props) {
  ...
  return (
    <>
      <div className={modal == true? "top-0 bottom-0 right-0 left-0 bg-black bg-opacity-40":""}>
                  ...
                  >
                    <div className={"flex w-[1216px] h-[40px]"}>
                      ...
                      <div className="w-[164px] grid justify-center">
                        <button className={state == true? "signup_wait":"signup_done"}>{state==true?'승인 대기':'승인 완료'}</button>
                      </div>
                      <div className={"w-[85px]"}>
                      ...
                      <div className={"w-[128px] grid justify-end"}>
                        <button className={state == true ? "signup_accept" : "signup_deny"}
                        onClick={()=>{
                          setState(!state)
                          console.log(state)
                        }}>{state == false ? '승인 취소':'승인'}</button>
                      </div>
                    </div>
                  </li>
                </>
