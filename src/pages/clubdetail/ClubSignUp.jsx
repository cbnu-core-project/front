...
function ManagerSignUp(props) {
  ...
  const [modal, setModal] = useRecoilState(userApplicationFormModalState);
  //승인
      ...
      <div className={''}>
        <div className={' ml-[64px] w-[1306px] h-[40px]'}>
          ...
          <div className="flex">
            ...
            <button
              className={
                'ml-auto w-[175px] h-[40px] rounded-md bg-sub text-white flex py-[10px] pl-[14px] transition hover:scale-110'
              }
              onClick={() => {
                setModal(!modal);
              }}
