    ...
    <>
      <div>
        ...
        <div className={'flex gap-3'}>
          <button
            className={
              homeTab === 0 ? 'btn-home-tab-focused' : 'btn-home-tab'
            }
          ...
          <button
            className={
              homeTab === 1 ? 'btn-home-tab-focused' : 'btn-home-tab'
            }
          ...
          <button
            className={
              homeTab === 2 ? 'btn-home-tab-focused' : 'btn-home-tab'
            }
...
const Image = (props) => {
  return (
    <div
      className={'h-[200px] 2xl:w-[300px] 2xl:h-[200px] overflow-y-scroll'}
    >
      <img
  ...
  return (
    <div className={'mx-[20px] my-[16px]'}>
      <div className={'gap-[10px] flex'}>
        <div
          className={'text-h3 2xl:text-h3 font-bold grid content-center'}
        >
          {props.post.title}
        </div>
        <div
